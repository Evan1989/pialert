...
$texts = array(
    ...
    'messageAlertCount' => 'Ошибка: нет сообщений или их количество за интервал меньше среднестатистического для интерфейса: ',
    'messageAlertProcTime' => 'Ошибка: время обработки сообщений за интервал превышает пороговое значение для интерфейса: ',
    'averageMessageCount' => 'Среднее количество сообщений= ',
    'currentMessageCount' => 'Количество сообщений за последний интервал= ',
    'averageMessageProcessingTime' => 'Среднее время(мс) обработки сообщений= ',
    'currentMessageProcessingTime' => 'Время(мс) обработки сообщений за последний интервал= ',
